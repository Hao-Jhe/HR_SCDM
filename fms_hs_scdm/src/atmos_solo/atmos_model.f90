...
!   ------ atmosphere integration loop -------
    ...
    do na = 1, num_atmos_calls
       ...
       call atmosphere (Time, count_int)   ! zw

       Time = Time + Time_step_atmos

       count_int = count_int + 1          ! zw
...
!----- write current/initial date actually used to logfile file -----
 ...
 16 format ('  current time used = day',i7,' hour',i3,2(':',i2.2))  ! hjh
...
!     compute ending time in days,hours,minutes,seconds
  ...
  20  format (6i8,2x,'day')   ! can handle day <= 9999999  !hjh
