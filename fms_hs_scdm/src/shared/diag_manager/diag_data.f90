...
MODULE diag_data_mod
  ...
  INTEGER, PARAMETER :: VERY_LARGE_FILE_FREQ = 1000000  ! 100000->1000000  !hjh Apr/13/2019
...
!  REAL :: FILL_VALUE = NF_FILL_FLOAT  ! from file /usr/local/include/netcdf.inc (nf_fill_real=nf_fill_float)
#else
