...
INC_NETCDF := -I$(NETCDFC_INCDIR) -I$(NETCDFF_INCDIR) #$(shell nc-config --fflags)
LIB_NETCDF :=  -L$(NETCDFC_LIBDIR) -Wl,-rpath=$(NETCDFC_LIBDIR) -L$(NETCDFF_LIBDIR) -Wl,-rpath=$(NETCDFF_LIBDIR) -lnetcdff -lnetcdf #$(shell nc-config --flibs)

FPPFLAGS := -fpp -Wp,-w
CPPFLAGS := $(INC_NETCDF) $(INC_MPI)

FFLAGS := -axCORE-AVX2,AVX,SSE4.2 -fno-alias -stack_temps -safe_cray_ptr -ftz -assume byterecl -i4 -r8 -nowarn -convert big_endian -fPIC -mcmodel=medium 
...
FFLAGS_NODEBUG += $(CPPDEFS) $(FPPFLAGS)
